...
public class ReformulationTest extends TestCase {
	...
	private void test_function(String ontoname, QuestPreferences pref)
			throws Exception {
	...
	public void test_600SINoEqNoSig() throws Exception {
		...
		pref.setCurrentValueOf(QuestPreferences.REFORMULATION_TECHNIQUE,
