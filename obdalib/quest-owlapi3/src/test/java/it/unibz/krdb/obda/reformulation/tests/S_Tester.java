...
public class S_Tester {
    ...
    private S_QuestOWL reasoner = null;
     ...
     *            expected results.
     */
    public S_Tester(String propfile) {
    ...
    public void load(String onto, QuestPreferences pref) throws Exception {
        ...
        S_QuestOWLFactory fac = new S_QuestOWLFactory();
        ...
        reasoner = (S_QuestOWL) fac.createReasoner(ontology);
