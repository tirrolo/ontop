...
public class SaveQueryPanel extends javax.swing.JPanel {
    ...
    /** Creates new form SaveQueryPanel */
    ...
    private void initCombo() {
         ...
         Vector<QueryGroupTreeElement> groups = qcontroller.getGroups();
         for (QueryGroupTreeElement queryGroup : groups) {
			comboGroups.insertItemAt(queryGroup.getID(), comboGroups.getItemCount());
		}
    ...
    private void initComponents() {
        ...
        comboGroups.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No group..." }));
...
// TODO add your handling code here:
    ...
    private void buttonAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAcceptActionPerformed
    	...
    	if (group == null) {
    		...
    		qcontroller.addQuery(query, id, group);
    	}
