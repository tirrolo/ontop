...
public class MssqlVirtualScenarioTest extends QuestVirtualScenarioParent {

	public MssqlVirtualScenarioTest(String testURI, String name, String queryFileURL, String resultFileURL, 
	...
	public static Test suite() throws Exception {
		return ScenarioManifestTestUtils.suite(new Factory() {
			...
			public QuestVirtualScenarioParent createQuestScenarioTest(String testURI, String name, String queryFileURL, 
				...
				return new MssqlVirtualScenarioTest(testURI, name, queryFileURL, resultFileURL, owlFileURL, 
						obdaFileURL, "");
			}
			@Override
			public QuestVirtualScenarioParent createQuestScenarioTest(String testURI, String name, String queryFileURL, 
			...
			public String getMainManifestFile() {
				return "/testcases-scenarios/virtual-mode/manifest-scenario-mssql.ttl";
			}
		});
	}
}
