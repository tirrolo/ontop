 ...
 * semantic.
 * 
 * Setting: Without Optimizing Equivalences and With Using TBox Sigma. 
 */
public class DLLiteCompletenessNoEqSigTest extends CompletenessParent {

	public DLLiteCompletenessNoEqSigTest(String tid, String name, String resf,
	...
	public static Test suite() throws Exception {
		return CompletenessTestUtils.suite(new Factory() {
			...
			public CompletenessParent createCompletenessTest(String testId,
				...
				return new DLLiteCompletenessNoEqSigTest(testId, testName,
			...
			public String getMainManifestFile() {
				return "/completeness/manifest-noeq-sig.ttl";
			}
		});
	}
}
