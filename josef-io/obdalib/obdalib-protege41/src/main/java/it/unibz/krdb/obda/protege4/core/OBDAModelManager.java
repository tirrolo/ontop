...
public class OBDAModelManager implements Disposable {
        ...
        public void ontologiesChanged(List<? extends OWLOntologyChange> changes) throws OWLException {
            ...
            for (int idx = 0; idx < changes.size(); idx++) {
                ...
                if (change instanceof RemoveAxiom && changes.get(idx + 1) instanceof AddAxiom) {
                    ...
                    // Found the patter we are looking for, a remove and add of declaration axioms
            ...
            for (OWLEntity olde : renamings.keySet()) {
                ...
                // This set of changes appears to be a "renaming" operation, hence we will modify the OBDA model accordingly
        ...
        public void handleChange(OWLModelManagerChangeEvent event) {
            ...
            case ONTOLOGY_RELOADED:
                ...
                try {
                    ...
                    File obdaDocument = new File(URI.create(obdaDocumentIri));
                    ...
                    try {
                        DataManager ioManager = new DataManager(activeOBDAModel);
                        URI obdaDocumentUri = obdaDocument.toURI();
                        ioManager.loadOBDADataFromURI(obdaDocumentUri, ontologyIRI.toURI(), activeOBDAModel.getPrefixManager());
                    } catch (SAXException e) {
                        // Migration Plan: Use the new IO manager if the the old one fails to load
                        IOManager ioManager = new IOManager(activeOBDAModel);
                        String obdaDocumentLocation = obdaDocument.getAbsolutePath();
                        ioManager.load(obdaDocumentLocation);
                    }
            ...
            case ONTOLOGY_SAVED:
                ...
                try {
                    ...
                    IOManager ioManager = new IOManager(activeOBDAModel);
                    ioManager.save(obdaDocumentLocation);
    ...
    private void triggerOntologyChanged() {
        ...
        try {
            ...
            log.warn("Exception forcing an ontology change. Your OWL model might contain a new class that you need to remove manually: {}", newClass.getIRI());
    ...
    private class ProtegeMappingControllerListener implements OBDAMappingListener {
        ...
        public void mappingUpdated(URI srcuri, String mapping_id,
