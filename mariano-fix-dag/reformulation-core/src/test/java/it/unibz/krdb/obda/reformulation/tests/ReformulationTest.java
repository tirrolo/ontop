...
//					QuestConstants.UCQBASED);
//			pref.setCurrentValueOf(ReformulationPlatformPreferences.DBTYPE,
//					QuestConstants.DIRECT);
//			pref.setCurrentValueOf(ReformulationPlatformPreferences.ABOX_MODE,
//					QuestConstants.CLASSIC);
//			pref.setCurrentValueOf(
//					ReformulationPlatformPreferences.OPTIMIZE_EQUIVALENCES,
//					"true");
//			pref.setCurrentValueOf(
//					ReformulationPlatformPreferences.OPTIMIZE_TBOX_SIGMA,
//					"false");
//			pref.setCurrentValueOf(
...
//				assertTrue("Expected " + exp + " Result " + res,
//						exp.size() == res.size());
//				for (String realResult : res) {
//					assertTrue("expeted: " + exp.toString() + " obtained: "
//							+ res.toString(), exp.contains(realResult));
//				}
//			}
//		}
//
...
//		}
		...
		/*
		 * Testing with sigma-tbox optimization
		 */
		{
			log.debug("Testing in-memory classic direct equivalences");
			ReformulationPlatformPreferences pref = new ReformulationPlatformPreferences();
