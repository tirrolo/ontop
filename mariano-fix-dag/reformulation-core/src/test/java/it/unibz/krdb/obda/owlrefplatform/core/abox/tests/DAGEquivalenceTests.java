...
public class DAGEquivalenceTests extends TestCase {
	...
	// private final String testEquivalenceClassesInv =
	// "src/test/resources/test/semanticIndex_ontologies/equivalence-classes-with-exists-inverse.owl";
	...
	public void testIndexClasses() throws Exception {
		...
		OWLOntology owlonto = man.loadOntologyFromPhysicalURI(new File(
				testEquivalenceClasses).toURI());
		Ontology onto = t.translate(owlonto);
		DAG dag = DAGConstructor.getDAG(onto);

		DAG pureIsa = dag.filterPureISA();
		...
		DAGNode node = pureIsa.getNode(ofac.createClass(URI.create(testURI
				+ "B1")));
		...
		node = pureIsa.getNode(ofac.createClass(URI.create(testURI + "B2")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		...
		node = pureIsa.getNode(ofac.createClass(URI.create(testURI + "B3")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 2);
		...
		node = pureIsa.getNode(ofac.createClass(URI.create(testURI + "A1")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		...
		node = pureIsa.getNode(ofac.createClass(URI.create(testURI + "A2")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 1);
		...
		node = pureIsa.getNode(ofac.createClass(URI.create(testURI + "A3")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 1);
	...
	public void testIntervalsRoles() throws Exception {
		...
		DAGNode node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI + "R1")));
		SemanticIndexRange range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		Interval interval = range.getIntervals().get(0);
 		assertEquals(interval.getEnd(), 2);

		node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI + "R2")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 2);
		...
		node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI + "R3")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 2);
		...
		node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI + "S1")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 1);
		...
		node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI + "S2")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 1);
		...
		node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI + "S3")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
		assertEquals(interval.getStart(), 1);
	...
	public void testIntervalsRolesWithInverse() throws Exception {
		...
		OWLOntologyManager man = OWLManager.createOWLOntologyManager();
		OWLOntology owlonto = man.loadOntologyFromPhysicalURI(new File(
				testEquivalenceRolesInverse).toURI());
		Ontology onto = t.translate(owlonto);
		...
		// DAGNode equi =
		// pureIsa.getNode((Property)pureIsa.equi_mappings.get(ofac.createObjectProperty(URI.create(testURI
		// + "A1"))));

		DAGNode node = pureIsa.getNode(ofac.createObjectProperty(URI
				.create(testURI + "A1")));
		SemanticIndexRange range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		Interval interval = range.getIntervals().get(0);
		...
		node = pureIsa.getNode(ofac.createObjectProperty(URI.create(testURI
				+ "A2")));
		range = node.getRange();
		assertEquals(range.getIntervals().size(), 1);
		interval = range.getIntervals().get(0);
