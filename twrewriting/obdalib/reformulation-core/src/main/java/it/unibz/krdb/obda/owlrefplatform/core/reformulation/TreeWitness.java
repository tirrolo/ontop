...
public class TreeWitness {
	...
	private Set<TreeWitnessGenerator> gens; // the \exists R.B concepts that realise the tree witness 
	...
	public TreeWitness(Set<TreeWitnessGenerator> gens, TermCover terms, boolean allRootsQuantified, Set<Atom> rootAtoms) {
		this.gens = gens;
		this.terms = terms;
	...
	public Set<TreeWitnessGenerator> getGenerators() {
		return gens;
	}
