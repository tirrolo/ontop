...
public class TreeWitness {
	private Set<Term> domain; // terms that are covred by the tree witness
	...
	public TreeWitness(PropertySomeClassRestriction gen, Set<Term> roots, Set<Atom> roottype, Set<Term> nonroots) {
		this.gen = gen;
		this.roots = roots;
